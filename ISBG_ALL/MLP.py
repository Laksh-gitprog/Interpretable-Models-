...
mlp_regressor = MLPRegressor(random_state=RANDOM_STATE, early_stopping=True)
...
model_path = RESULTS_DIR / 'best_mlp_model.pkl'
scaler_path = RESULTS_DIR / 'mlp_feature_scaler.pkl'
...
predictions_path = RESULTS_DIR / 'mlp_test_predictions.csv'
