...
print("Loading data...")
df = pd.read_csv(r"C:\Users\Laksh\Downloads\COCOMO_81.csv")
print(f"Dataset shape: {df.shape}")

X = df.drop('actual', axis=1)
y = df['actual']
print(f"Features: {X.shape[1]}")
print(f"Target variable: actual")
...
lr = LinearRegression()
grid_search = GridSearchCV(lr, param_grid, cv=5, scoring='neg_root_mean_squared_error', 
                          n_jobs=-1, verbose=2)
...
output_dir = Path('results/linear_regression')
