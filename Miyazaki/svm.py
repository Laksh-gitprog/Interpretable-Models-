...
print("Loading data...")
df = pd.read_csv(r"C:\Users\Laksh\Downloads\Miyazaki.csv")
print(f"Dataset shape: {df.shape}")

X = df.drop('MM', axis=1)
y = df['MM']
print(f"Features: {X.shape[1]}")
print(f"Target variable: MM")
...
svm = SVR()
grid_search = GridSearchCV(svm, param_grid, cv=5, scoring='neg_root_mean_squared_error', 
                          n_jobs=-1, verbose=2)
...
print("\n" + "="*60)
print("SVM (Support Vector Machine) - Performance Metrics")
print("="*60)
